...
create database sip default charset utf8 collate utf8_general_ci;
USE sip;
...
(
    ...
    comment 'API secret表' engine = InnoDB;
...
# INSERT INTO user (id, app_id, username, nickname, content, cdate, udate, cuid, type, status)
# VALUES (1, 1, 'test', 'test', '{}', unix_timestamp(), unix_timestamp(), 0, 'SYSTEM_SUPER_ADMIN', 0);
# INSERT INTO user_auth (id, app_id, uid, type, username, password, cdate, udate, ldate)
# VALUES (1, 1, 1, 0, 'test', '$2a$10$3d7ykD7OxOTglE6DcLdhWerSpViDhIAyz6CylkBg.QkRlTgtduQCa', unix_timestamp(),
#         unix_timestamp(), unix_timestamp());
# INSERT INTO app (id, name, code, cdate, udate)
# VALUES (1, 'SIP', 'sip', unix_timestamp(), unix_timestamp());
# INSERT INTO app_service (id, app_id, name, path, server_id, url, strip_prefix, retryable, sensitive_headers, cdate,
#                          udate)
# VALUES (1, 1, 'sip-base', '/base/**', 'sip-base', '', 1, 1, null, unix_timestamp(), unix_timestamp());
# INSERT INTO app_service (id, app_id, name, path, server_id, url, strip_prefix, retryable, sensitive_headers, cdate,
#                          udate)
# VALUES (2, 1, 'sip-dict', '/dict/**', 'sip-dict', '', 1, 1, null, unix_timestamp(), unix_timestamp());
# INSERT INTO app_service (id, app_id, name, path, server_id, url, strip_prefix, retryable, sensitive_headers, cdate,
#                          udate)
# VALUES (3, 1, 'sip-permission', '/permission/**', 'sip-permission', '', 1, 1, null, unix_timestamp(), unix_timestamp());
# INSERT INTO app_service (id, app_id, name, path, server_id, url, strip_prefix, retryable, sensitive_headers, cdate,
#                          udate)
# VALUES (4, 1, 'sip-notify', '/notify/**', 'sip-notify', '', 1, 1, null, unix_timestamp(), unix_timestamp());
# INSERT INTO app_service (id, app_id, name, path, server_id, url, strip_prefix, retryable, sensitive_headers, cdate,
#                          udate)
# VALUES (5, 1, 'sip-tools', '/tools/**', 'sip-tools', '', 1, 1, null, unix_timestamp(), unix_timestamp());
#
# INSERT INTO dict (id, name, value, description, lft, rgt, lvl, fixed, isdel)
# VALUES (1, '根', 'root', '根', 1, 2, 0, 0, 0);
#
# INSERT INTO role (id, app_id, code, name, cdate, udate, enable)
# VALUES (1, 1, 'GUEST', '访客', unix_timestamp(), unix_timestamp(), 1);
# INSERT INTO permission (id, app_id, name, code, cdate, udate)
# VALUES (1, 1, '访客', 'GUEST', unix_timestamp(), unix_timestamp());
# INSERT INTO role_permission (id, app_id, role_id, permission_id, cdate)
# VALUES (1, 1, 1, 1, 0);
#
# INSERT INTO permission_resource (id, app_id, permission_id, resource_id, cdate)
# VALUES (1, 1, 1, 25, unix_timestamp());
# INSERT INTO permission_resource (id, app_id, permission_id, resource_id, cdate)
# VALUES (2, 1, 1, 24, unix_timestamp());
# INSERT INTO permission_resource (id, app_id, permission_id, resource_id, cdate)
# VALUES (3, 1, 1, 26, unix_timestamp());
#
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (1, 1, 0, '基础服务', '/base', 0, '<svg viewBox="0 0 1024 1024" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (2, 1, 1, '应用管理', '/base/app', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (3, 1, 1, '应用服务', '/base/app-service', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (4, 1, 1, 'Secrets', '/base/app-secret', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (5, 1, 1, '用户模板', '/base/user-template', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (6, 1, 1, '用户管理', '/base/user', 0, '<svg viewBox="0 0 1024 1024" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (7, 1, 0, '字典服务', '/dict', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (8, 1, 7, '字典管理', '/dict/dict', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (9, 1, 0, '权限服务', '/permission', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (10, 1, 9, '角色管理', '/permission/role', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (11, 1, 9, '菜单管理', '/permission/menu', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
#   <path d="M3,18h18v-2H3V18z M3,13h18v-2H3V13z M3,6v2h18V6H3z"></path>
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (12, 1, 9, '权限管理', '/permission/permission', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
#   <path d="M18,8h-1V6c0-2.76-2.24-5-5-5S7,3.24,7,6v2H6c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V10
# 		C20,8.9,19.1,8,18,8z M9,6c0-1.66,1.34-3,3-3s3,1.34,3,3v2H9V6z M18,20H6V10h12V20z M12,17c1.1,0,2-0.9,2-2c0-1.1-0.9-2-2-2
# 		c-1.1,0-2,0.9-2,2C10,16.1,10.9,17,12,17z"/>
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (13, 1, 9, '资源管理', '/permission/resource', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (14, 1, 0, '日志服务', '/logs', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (15, 1, 14, '日志模板', '/logs/template', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
#   <path d="M19,2H5C3.9,2,3,2.9,3,4v14c0,1.1,0.9,2,2,2h4l3,3l3-3h4c1.1,0,2-0.9,2-2V4C21,2.9,20.1,2,19,2z M19,18h-4h-0.83l-0.59,0.59L12,20.17l-1.59-1.59L9.83,18H9H5V4h14V18z"/>
#   <polygon points="12,17 13.88,12.88 18,11 13.88,9.12 12,5 10.12,9.12 6,11 10.12,12.88"/>
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (16, 1, 14, '日志报警', '/logs/warn', 0, '<svg viewBox="0 0 1024 1024" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (17, 1, 0, '通知服务', '/notify', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
#   <path d="M19,3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V5C21,3.9,20.1,3,19,3z M19,19H5V5h14V19z"/>
# 		<polygon points="15,15 11,15 11,13 15,13 15,11 11,11 11,9 15,9 15,7 9,7 9,17 15,17 		"/>
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (18, 1, 17, '邮件配置', '/notify/mail-sender', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (19, 1, 17, '邮件模板', '/notify/mail-template', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (20, 1, 17, '短信模板', '/notify/sms', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
#   <path d="M18,8h-1V6c0-2.76-2.24-5-5-5S7,3.24,7,6v2H6c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V10
# 		C20,8.9,19.1,8,18,8z M9,6c0-1.66,1.34-3,3-3s3,1.34,3,3v2H9V6z M18,20H6V10h12V20z M12,17c1.1,0,2-0.9,2-2c0-1.1-0.9-2-2-2
# 		c-1.1,0-2,0.9-2,2C10,16.1,10.9,17,12,17z"/>
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (21, 1, 17, '短信配置', '/notify/sms-config', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
#   <path d="M19,19H5V5h7V3H5C3.89,3,3,3.9,3,5v14c0,1.1,0.89,2,2,2h14c1.1,0,2-0.9,2-2v-7h-2V19z M14,3v2h3.59l-9.83,9.83l1.41,1.41
# 		L19,6.41V10h2V3H14z"/>
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (22, 1, 0, '工具服务', '/tools', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
...
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (23, 1, 22, 'kubeCharts', '/tools/kube-charts', 0, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">
#   <path d="M18,2H6C4.9,2,4,2.9,4,4v16c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V4C20,2.9,19.1,2,18,2z M9,4h2v5l-1-0.75L9,9V4z M18,20H6V4
# 		h1v9l3-2.25L13,13V4h5V20z"/>
# </svg>', 'PAGE', 1);
# INSERT INTO menu (id, app_id, pid, name, path, sort, icon, type, display)
# VALUES (24, 1, 0, '首页', '/', -1, '<svg viewBox="0 0 24 24" width="24px" height="24px" fill="currentColor">

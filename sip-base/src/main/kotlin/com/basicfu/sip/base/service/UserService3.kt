...
//import com.basicfu.sip.base.common.enum.Enum.Condition
//import com.basicfu.sip.base.common.enum.Enum.FieldType.*
//import com.basicfu.sip.base.common.enum.Enum.UserType
...
// */
//@Service
//class UserService3 : BaseService<UserMapper, User>() {
//    @Autowired
...
////            }
////            when (vo.type) {
////                UserType.SYSTEM_SUPER_ADMIN.name -> throw CustomException(com.basicfu.sip.base.common.enum.Enum.NOT_PERMISSION_ADD_SYSTEM_SUPER_ADMIN)
////                UserType.SYSTEM_ADMIN.name ->
////                    currentUser.type != UserType.SYSTEM_SUPER_ADMIN.name && throw CustomException(com.basicfu.sip.base.common.enum.Enum.NOT_PERMISSION_ADD_SYSTEM_ADMIN)
////                UserType.APP_SUPER_ADMIN.name -> throw CustomException(com.basicfu.sip.base.common.enum.Enum.NOT_PERMISSION_ADD_APP_SYSTEM_ADMIN)
...
////                            throw CustomException(com.basicfu.sip.base.common.enum.Enum.NOT_PERMISSION_ADD_APP_ADMIN)
////                //允许普通用户通过分配的角色添加普通用户
...
////                throw CustomException(com.basicfu.sip.base.common.enum.Enum.SUPER_ADMIN_NOT_CHANGE_USER_TYPE)
////            }
////            //如果发生系统/应用级别变化禁止
////            if (UserType.valueOf(user.type!!).system != UserType.valueOf(vo.type!!).system) {
////                throw CustomException(com.basicfu.sip.base.common.enum.Enum.SYSTEM_USER_NOT_EXCHANGE_APP_USER)
////            }
////            when (vo.type) {
////                UserType.SYSTEM_SUPER_ADMIN.name -> throw CustomException(com.basicfu.sip.base.common.enum.Enum.NOT_PERMISSION_ADD_SYSTEM_SUPER_ADMIN)
////                UserType.SYSTEM_ADMIN.name ->
